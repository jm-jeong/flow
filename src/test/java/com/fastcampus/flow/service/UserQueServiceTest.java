...
class UserQueServiceTest {
    ...
    void isNotAllowedByToken() {
        StepVerifier.create(userQueService.isAllowedByToken("default", 100L, ""))
                .expectNext(false)
                .verifyComplete();
    }
    ...
    void isAllowedByToken() {
        StepVerifier.create(userQueService.isAllowedByToken("default", 100L, "d333a5d4eb24f3f5cdd767d79b8c01aad3cd73d3537c70dec430455d37afe4b8"))
                .expectNext(true)
                .verifyComplete();
    }
    ...
    @Test
    void generateToken() {
        StepVerifier.create(userQueService.generateToken("default", 100L))
